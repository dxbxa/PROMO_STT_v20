...
class A_Estadisticas {
    ...
    public A_Estadisticas(int pDATOS_30,	int pDATOS_7,	int pDATOS_1,	String pPROMESA,	int pCONTACTACION_7,	int pEFECTIVIDAD_7,	int pVENTA_7,	int pCONTACTACION_30,	int pEFECTIVIDAD_30,	int pVENTA_30,	int pCONTACTACION_1,	int pEFECTIVIDAD_1,	int pVENTA_1){
        DATOS_30=pDATOS_30;
        DATOS_7=pDATOS_7;
        DATOS_1=pDATOS_1;
        PROMESA=pPROMESA;
