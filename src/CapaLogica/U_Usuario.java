...
class U_Usuario {
    ...
    public U_Usuario(String pCOD_USUARIO,String pCEDULA,String pNOMBRE_USUARIO,	String pEMAIL_USUARIO,String pROL_USUARIO,String pCLAVE_USUARIO){
    ...
    // <editor-fold defaultstate="collapsed" desc="SETs DEL OBJETO">
        ...
        public void setPROYECTO( P_Proyecto pobjProyecto){objProyecto=pobjProyecto;}
    // </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="GETs DEL OBJETO">
        ...
        public P_Proyecto getPROYECTO(){return objProyecto;}
    // </editor-fold>
