...
class C_Contacto {
    ...
    // <editor-fold defaultstate="collapsed" desc="DECLARACION DE LOS ATRIBUTOS DEL OBJETO">
        ...
        private C_Telefono[] arrayTelefonos;
        private C_Identificador[] arrayIdentificadores;
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="CONSTRUCTORES DEL OBJETO">

    public C_Contacto(String pCEDULA,String pNOMBRE_CONTACTO,String pCOD_CUENTA,String pTarjeta,String pNOMBRE_BASE){
        CEDULA=pCEDULA;
    ...
    public void setTELEFONOS(C_Telefono[] parrayTelefonos){arrayTelefonos=parrayTelefonos;}
    public void setIDENTIFICADORES(C_Identificador[] parrayIdentificadores){arrayIdentificadores=parrayIdentificadores;}
    // </editor-fold>
    ...
    public C_Telefono[] getTELEFONOS(){return arrayTelefonos;}
    public C_Identificador[] getIDENTIFICADORES(){return arrayIdentificadores;}
    // </editor-fold>
